...
from src.config import ConfigurationError, LoggerError, get_config_manager, setup_logger
from src.infrastructure.database import DatabaseError, get_database_manager, initialize_database
from src.services import DataProcessingError, get_data_processor
    ...
    def get_status(self) -> dict:
        ...
        if self._logger:
            try:
                ...
                status.update(
                    {"app_name": config.APP_NAME, "environment": config.APP_ENV, "log_level": config.LOG_LEVEL}
                )
