...
class UserData(BaseModel):
    ...
    processed: bool | None = Field(default=False, description="是否已处理")
...
class ProcessedUserData(UserData):
    ...
    processed: bool | None = Field(default=True, description="是否已处理")
    ...
    def __str__(self) -> str:
        ...
        """
        return (
            f"ProcessedUserData(name='{self.name}', age={self.age}, "
