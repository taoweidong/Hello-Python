...
from ..models import DataRecord, ProcessedData, AnalysisResult, get_data_validator
...
class DataProcessingService:
    ...
    def process_data_records(self, data_records: List[DataRecord], 
                           processing_type: str = "normalization") -> List[ProcessedData]:
        """处理数据记录
