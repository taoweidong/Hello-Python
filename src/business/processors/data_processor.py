...
class DataProcessor:
    ...
    def load_and_process_csv(self, file_path: str, 
                            processing_steps: Optional[List[Callable]] = None) -> List[ProcessedData]:
        """加载CSV文件并处理数据
...
_processing_pipeline: Optional[DataProcessingPipeline] = None
