...
class DatabaseManager:
    ...
    def __init__(self, default_url: str | None = None, echo: bool = False):
        """初始化数据库管理器
    ...
    def create_tables(self, db_name: str | None = None) -> None:
        """创建所有表
    ...
    def drop_tables(self, db_name: str | None = None) -> None:
        """删除所有表
...
def get_database_manager(default_url: str | None = None, echo: bool = False) -> DatabaseManager:
    """获取全局数据库管理器实例
...
def initialize_database(
    config: dict[str, str] | None = None, default_url: str | None = None, echo: bool = False
) -> None:
    """初始化数据库配置
