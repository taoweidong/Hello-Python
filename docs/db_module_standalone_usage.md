...
[db](file:///E:/GitHub/Hello-Python/db) 模块设计为可独立使用的数据库操作库，除了配置依赖外，其他功能都可以快速复制到其他项目使用。
...
- **装饰器**: [transactional](file:///E:/GitHub/Hello-Python/db/decorators.py#L15-L73) 和 [with_db_session](file:///E:/GitHub/Hello-Python/db/decorators.py#L75-L109) 用于简化数据库操作
...
创建自己的数据模型，继承 [BaseModel](file:///E:/GitHub/Hello-Python/db/models.py#L10-L17)：
...
1. 复制 [db](file:///E:/GitHub/Hello-Python/db) 目录到新项目
2. 移除 [example_models.py](file:///E:/GitHub/Hello-Python/db/example_models.py)（仅用于示例）
3. 根据需要调整配置
4. 创建自己的数据模型
5. 开始使用数据库功能